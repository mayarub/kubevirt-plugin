...
import NetworkInterfaceList from '@virtualmachines/creation-wizard-new/steps/CustomizationStep/components/CustomizeVirtualMachine/components/CustomizeVMTabs/tabs/network/NetworkInterfaceList';
