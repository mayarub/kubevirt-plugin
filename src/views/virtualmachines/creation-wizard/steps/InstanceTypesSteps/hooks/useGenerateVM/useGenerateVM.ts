...
} from '@virtualmachines/creation-wizard/state/vm-wizard-form/consts';
import {
  generateVM,
  isWindowBootableVolume,
} from '@virtualmachines/creation-wizard/steps/InstanceTypesSteps/hooks/useGenerateVM/utils/generateVM';
